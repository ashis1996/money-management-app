...
export class GoalController {
  ...
  create(@User() user: RequestUser, @Body() dto: CreateGoalDto) {
  ...
  findAll(@User() user: RequestUser, @Query('includeCompleted') includeCompleted?: string) {
  ...
  update(@User() user: RequestUser, @Param('id') id: string, @Body() dto: UpdateGoalDto) {
  ...
  contribute(@User() user: RequestUser, @Param('id') id: string, @Body() dto: ContributeGoalDto) {
